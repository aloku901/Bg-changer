    ...
    <div className="w-full h-screen" style={{backgroundColor: color}}>
      <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2">
        <div className="flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-2xl">
          ...
          <button onClick={() => (setColor("Gray"))} className="outline-none px-4 py-1 rounded-2xl text-white shadow-lg" style={{backgroundColor: "Gray"}}>Gray</button>
          <button onClick={() => (setColor("Yellow"))} className="outline-none px-4 py-1 rounded-2xl shadow-lg" style={{backgroundColor: "Yellow"}}>Yellow</button>
          <button onClick={() => (setColor("Pink"))} className="outline-none px-4 py-1 rounded-2xl shadow-lg" style={{backgroundColor: "Pink"}}>Pink</button>
          ...
          <button onClick={() => (setColor("White"))} className="outline-none px-4 py-1 rounded-2xl shadow-lg" style={{backgroundColor: "White"}}>White</button>
        </div>
      </div>
    </div>
  )
